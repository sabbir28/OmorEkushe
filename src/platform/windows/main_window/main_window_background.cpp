// =============================================================================
// File   : main_window_background.cpp
// Module : platform/windows/main_window (Background Image Renderer)
// Purpose: Loads and renders the main window's background image. Supports
//          multiple image formats (BMP, JPG, PNG) via stb_image.
//
//          Pipeline:
//            1. ResolveBackgroundImagePath() searches data/ directories for
//               bg.bmp or Bann2011.jpg
//            2. LoadBackgroundBitmapForWindow() loads the image via stb_image,
//               converts RGBA -> BGRA pixel order, and uses StretchBlt to
//               scale it to the current client rect dimensions.
//            3. DrawWindowBackground() alpha-blends the cached bitmap onto
//               the target HDC during WM_PAINT using AlphaBlend() with a
//               configurable opacity (g_backgroundOpacity, default 180/255).
//
//          NOTE: STB_IMAGE_IMPLEMENTATION is defined here — this must be the
//          ONLY translation unit that defines it to avoid multiple definition
//          linker errors.
// =============================================================================
