// =============================================================================
// File   : main_window_helpers.cpp
// Module : platform/windows/main_window (UI Helper Utilities)
// Purpose: Shared utility functions used by other main_window sub-modules.
//
//          Path helpers:
//            BuildPath()  — concatenates base directory + relative path
//
//          Icon loaders:
//            LoadIconFromPath()    — loads .ico files via LoadImageW
//            LoadAppIconFromData() — searches data/ directories for Bijoy.ico
//            LoadLayoutIcon()      — loads a layout-specific .ico by name
//
//          Image helpers:
//            WideToUtf8()       — converts wstring -> UTF-8 string (for stb_image)
//            LoadPngAsBitmap()  — loads a PNG via stb_image, converts RGBA->BGRA
//                                 with pre-multiplied alpha, and returns an HBITMAP
//                                 scaled to the requested dimensions via AlphaBlend
//
//          Window helpers:
//            SnapWindowToTop()  — pins the window to Y=kForcedTopY (top of screen)
// =============================================================================
