// =============================================================================
// File   : main_window_layout.cpp
// Module : platform/windows/main_window (Layout Selection & Display)
// Purpose: Manages layout selection UI and visual state synchronization.
//
//          SelectLayout(): Activates a layout by index, updates the combobox
//          selection, loads the layout-specific icon (.ico), binds the layout
//          to the current foreground window, and synchronizes the system tray
//          icon and tray context menu radio-button state.
//
//          PopulateLayoutCombo(): Fills the toolbar combobox with discovered
//          layout names (plus "English" as index -1) at startup.
//
//          CycleToNextLayout(): Cycles through layouts in round-robin order
//          (English -> Layout 0 -> Layout 1 -> ... -> English), triggered
//          by tray icon left-click.
// =============================================================================
